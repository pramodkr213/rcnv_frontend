...
import { getInternshipsApi } from "../../../api/employer/employer";
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border">
            <thead className="bg-[#D1E6FF]">
              <tr>
                <th className="p-2 border text-center">Internship Profile</th>
                <th className="p-2 border text-center">Location</th>
                <th className="p-2 border text-center">Stipend</th>
                ...
                internships.map((internship, index) => (
                  <tr key={index} className="text-sm">
                    <td className="p-2 text-center border text-blue-500 cursor-pointer underline">
                      <span
                        onClick={() =>
                          navigate(`/user/stats/myinternships/${internship.id}`)
                        }
                      >
                        {internship.title}
                      </span>
                    ...
                    <td className="p-2 text-center border ">
                      <div className="flex items-center justify-center gap-2 text-center">
                        <div className="text-lg">
                          {internship.numberOfApplications}
                        </div>
